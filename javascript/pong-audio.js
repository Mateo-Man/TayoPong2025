...
export var wallSound = new soundFile("bird-point.mp3"); //load sound
soundArray.push(wallSound); //add sound to list of sounds

export var paddleSound = new soundFile("water-droplet.mp3");
soundArray.push(paddleSound);

export var scoreSound = new soundFile("chime-score.mp3");
soundArray.push(scoreSound);

export var ambientSound = new soundFile("rain-birds.mp3");
soundArray.push(ambientSound);
ambientSound.player.loop = true; //turn on looping
ambientSound.player.volume.value = -16; //turn down volume

export var adventureMusic = new soundFile("piano.mp3");
soundArray.push(adventureMusic);
adventureMusic.player.loop = true;
adventureMusic.player.volume.value = -12;
